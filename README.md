# OSL - IES Puerto de la Cruz (osl.iespto)
...
* Integración curricular y apoyo docente.
* Fomento de valores de colaboración y participación.
* Elaboración y publicación de recursos abiertos.
* Soporte y consulta permanente.

## Documentación

* Propuesta de creación de la [Mini Oficina del Software Libre - IES Puerto de la cruz](./docs/propuesta.md) - Descargar en formato [PDF](./docs/pdf/Proyecto_Mini_Oficina_de_Software_Libre_OSL_en_IES_Puerto_de_la.pdf)
...
[Otras noticias relacionadas con el software libre](./ext/README.md)
